...
public class manageMember {
	...
	public manageMember(int mId, String userId, String userPwd, String userName, String email, String phone,
			Date mCreateDate, Date mModifyDate, String mStatus) {
		super();
		this.mId = mId;
		this.userId = userId;
	...
	public String toString() {
		return "manageMember [mId=" + mId + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
