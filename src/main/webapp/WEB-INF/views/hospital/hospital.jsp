...
<head>
    ...
    <link href="./intranet/all.min.css" rel="stylesheet" type="text/css">
    <link href="./intranet/css" rel="stylesheet">
    <link href="./intranet/1_content" rel="stylesheet">


    <!-- Custom styles for this template-->
    <link href="./intranet/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - 품의 관리 -->
            <li class="nav-item">
                <a class="nav-link" href="../intranet/intranet_calender.html">
            ...
            <div class="row">
                        ...
                        <div class="card-columns">
                            ...
                            <div class="card" style="width:500px">
                                <div class="card-body text-center">
                                    ...
                                    <div class="card-body text-center" style="width: auto; height: 200px;">
                                        <label class="btn btn-primary "> 사진등록
                                            <input type="file" class="img-fluid" alt="" style="display: none;">
                                        </label>
                                    </div>
                                    <p>동물병원</p>
                            ...
                            <div class="card" style="width:500px text-align=center;">
                                <div class="card-body text-center">
                                    ...
                                    <textarea style="width: 450px; height: 200px; border: none; resize: none;">병원소개</textarea>
                ...
                <div class="col-lg-11 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-columns" id="cccbody" style="column-count: 1;">
                            ...
                            <div class="card" style="width:200px; height: auto; display: inline-block;" id="copy">
                                <div class="card-body text-center">
                                    ...
                                    <br><br>
                                    <input type="text" style="text-align: center; width: 100px; border: none;"
                                        value="의사이름">
                                    <hr>
                                    <textarea
                        ...
                        <div style="text-align: center;">
                            <input id="ss" type='button' class='btn btn-primary copy' value='추가' style="width: 50px;">
