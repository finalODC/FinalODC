<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="com.ohdogcat.odc.homepage.member.model.vo.*"%>
...
<body>
  ...
  <jsp:include page="../homepage/common/menubar.jsp"/>
	...
	<div class="container" style="padding-top: 150px;">
		...
		<div class="wrap" style="max-width: 1180px; margin: 0 auto;">
			<h1
				style="text-align: left; width: 100%; height: 120px; border-bottom: 1px solid #999; line-height: 100px; color: #30627e;">${ hospital.hName }</h1>
			...
			<div class="sea"
				...
				<div class="par"
					style="width: 50%; height: 370px; float: left; border: none;">
					<img class="" id="preview"
						src="/odc/resources/hosImages/${hospital.hFile }"
				...
				<div class="ssa" style="width: 50%; height: 370px; float: right;">
					...
					<div
						style="width: 100%; height: 370px; border: none; resize: none; text-align: center;"
						readonly>
						<br>
						...
						<textarea style="width: 90%; border: none; resize: none;" readonly>병원이름  ${ loginUser.hName}</textarea>
						<textarea
							style="width: 90%; height: 60%; border: none; resize: none;"
							readonly>${ loginUser.hComment }</textarea>
			...
			<div class="two" style="width: 100%;">
				...
				<script type="text/javascript"
					src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3e673705a792756e975aa786d62b3807&libraries=services">
				...
				<textarea
					style="width: 90%; height: 50px; border: none; resize: none;"
					id="add1" readonly></textarea>
							...
							<c:forEach var="b" items="${hospital.doctor }">
								...
								<div class=""
									...
									<div class="" style="text-align: center;">
										<img class="" name="docFile"
											src="/odc/resources/docImages/${b.docFile }" id="docFile"
											style="width: 90%; height: 200px;"> <br> <br>
										<input type="text"
											style="text-align: center; width: 100px; border: none;"
											name="docName" class="docName" value="${b.docName }">
										<br> <br>
										<textarea
											style="text-align: center; width: 150px; height: 200px; border: none; resize: none;"
											name="docIntro" class="docIntro" placeholder="간단한 소개">${ b.docIntro }</textarea>
									</div>
			...
			<div class="">
				<div class="">
					...
					<table align="center" width="510" border="1" cellspacing="0">
						<tr>
							<td><textarea rows="3" cols="55" id="hrContent"
