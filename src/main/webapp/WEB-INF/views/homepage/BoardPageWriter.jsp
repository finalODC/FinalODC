          ...
          <table class="table table-bordered" align="center">
            ...
            <tbody>
              <tr>
                ...
                <td><input type="text" style="border:0px;"  placeholder="제목을 입력하세요"></td>
              </tr>
              <tr>
                <th>아이디</th>
                <td><input type="text" style="border:0px;" value="tlqkrus"  readonly></td>
              </tr>
              <tr>
                <th style="width:100px; height: 500px;">내용</th>
                <td><input type="text" value="스마트 에디터 넣자"></td>
