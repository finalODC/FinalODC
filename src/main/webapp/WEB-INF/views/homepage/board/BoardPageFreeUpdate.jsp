				...
				<div class="container" align="right">
					...
					<table class="table table-bordered" align="center">
						...
						<tbody>
							...
							<tr>
								<th>아이디</th>
								<td><input type="text" readonly style="border:0px" style="border:0px" name="fbWriter" value="${fb.fbWriter}"></td> 
										
								
							</tr>
							<tr>
								<th style="width: 100px; height: 500px;">내용</th>
								<td><textarea id="editer" rows="25" cols="140" name="fbContent">${fb.fbContent }</textarea></td>

							</tr>
							
						</tbody>
					</table>
					<button type="button" class="btn btn-outline-success"  style="border:1px solid green" id="ubtn">수정하기</button>
					<button type="button" class="btn btn-outline-danger" style="border:1px solid red" onclick="gotoback()">취소</button>
