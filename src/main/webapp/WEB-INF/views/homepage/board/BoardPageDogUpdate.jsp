					...
					<table class="table table-bordered" align="center">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" style="border: 0px; width: 400px;"  name="tbTitle" value="${db.tbTitle }"> </td>
							</tr>
							<tr>
								<th>아이디</th>
								<td><input type="text" readonly style="border:0px" name="tbWriter" value="${db.tbWriter}"></td> 
										
								
							</tr>
							<tr>
								<th style="width: 100px; height: 500px;">내용</th>
								<td><textarea id="editer" rows="25" cols="140" name="tbContent">${db.tbContent }</textarea></td>

							</tr>
							
						</tbody>
					</table>
					<button type="button" class="btn btn-outline-success" style="border:1px solid green"  id="dubtn">수정하기</button>
					<button type="button" class="btn btn-outline-danger" style="border:1px solid red" onclick="Doggotoback()">취소</button>
  ...
  var adminid
	...
	<script type="text/javascript">
      ...
      $(function(){
        ...
        function Doggotoback(){
        	
        	location.href="DogcencleW.bo";
        }
